...
function pickRandomTag() {   //this will pick random tag
    const tags = document.querySelectorAll('.tag')
    return tags[Math.floor(Math.random() * tags.length)]
}

function heighlight(tag) {  //this will highlight choices
    tag.classList.add('highlight');
}

function unHighlight(tag) { //this will unhighlight choices
